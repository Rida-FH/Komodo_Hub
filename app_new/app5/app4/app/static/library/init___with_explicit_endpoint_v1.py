...
users = {
    ...
    'teacher': {'username': 'teacher_user', 'email': 'teacher@email.com', 'join_date': '2023-10-01', 'user_type': 'teacher'}
}
...
@app.route('/library_teacher', endpoint='library_teacher')
def library_teacher():
    user_type = session.get('user_type', 'student')
...
def home_teacher():
    ...
    user = users[user_type]
    return render_template('home_teacher.html', username=user['username'], messages=messages, user_type=user_type)
